...
class CarouselSlider extends StatefulWidget {
  ...
  final PlutoCarouselSliderControllerImpl _carouselController;
  ...
  CarouselSlider(
      ...
      this.disableGesture,
      PlutoCarouselSliderController? carouselController,
      Key? key})
      : itemBuilder = null,
        itemCount = items != null ? items.length : 0,
        _carouselController = carouselController != null
            ? carouselController as PlutoCarouselSliderControllerImpl
            : PlutoCarouselSliderController() as PlutoCarouselSliderControllerImpl,
        super(key: key);
...
class CarouselSliderState extends State<CarouselSlider>
  ...
  final PlutoCarouselSliderControllerImpl carouselController;
  Timer? timer;
